...
gameState.load.prototype = {
	preload: function() {
		...
		game.load.image('branch1', 'img/branch1.png');
		game.load.image('branch2', 'img/branch2.png');
...
gameState.main.prototype = {
	...
	update: function() {
		...
		listener: function(action) {
			...
			if(nameTrunkToCut == 'branch1' && this.manPosition == 'left' || nameTrunkToCut == 'branch2' && this.manPosition == 'right') {
				//Game Over
				this.death();
		...
		if (nameTrunkJustAfter == 'branch1' && this.manPosition == 'left' || nameTrunkJustAfter == 'branch2' && this.manPosition == 'right') {
			//Game Over
			this.death();
		}
	}
...
cutTrunk: function() {
	...
	death: function() {
		//On empeche toute action du joueur
		GAME_START = false;
		GAME_OVER = true;
		this.canCut = false;
